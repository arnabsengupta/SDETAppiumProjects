...
// 2.Goal: Opening a page on the browser and testing a simple login page with correct and incorrect credentials
public class LoginTest {
	...
	public void verifyInvalidCredentialsTest() {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='2']"))).sendKeys(invalidUserName);
		driver.findElementByXPath("//android.widget.EditText[@index='4']").sendKeys(invalidPassword);
	...
	public void verifyValidCredentialsTest() {
		...
		//Enter valid credentials
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='2']"))).sendKeys(validUserName);
		driver.findElementByXPath("//android.widget.EditText[@index='4']").sendKeys(validPassword);
